...
name: manifest
tier: 0
description: "Configure Domo app manifest.json mappings for datasets, workflows, collections, collectionsMapping, Code Engine packagesMapping contracts, alias naming rules, and fileset exceptions. Trigger with 'manifest', 'manifest.json', 'datasetsMapping', 'workflowMapping', 'collectionsMapping', 'packagesMapping', 'domo manifest'."
maturity: alpha
audience: [code]
---
  ...
  "datasetsMapping": [
    {
      ...
      "dataSetId": "abc-123-def-456",   // Use 'dataSetId' NOT 'id'
      "fields": []                       // REQUIRED - must be present even if empty
    }
  ]
}
```
