...
name: data-api
tier: 0
description: "High-level entry skill for Domo data access routing query work to dataset-query, covering Query API, SqlClient, manifest wiring, and local dev proxy setup. Trigger with 'data api', 'data access', 'dataset', 'domo data', 'datasetsMapping', 'fetch data'."
maturity: alpha
audience: [code]
---
