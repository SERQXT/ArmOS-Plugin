...
name: fileset-cli
tier: 0
description: "Use community-domo-cli to create, discover, browse, upload, download, and query files in Domo FileSets from the command line. Trigger with 'fileset', 'filesets cli', 'upload file to domo', 'download file from domo', 'fileset query'."
maturity: alpha
audience: [code]
---
