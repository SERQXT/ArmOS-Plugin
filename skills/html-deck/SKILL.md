...
name: html-deck
tier: 0
description: "Build professional HTML slide decks and convert to pixel-perfect PDFs using headless Chrome — Domo-branded templates, print-safe CSS, Puppeteer conversion. Trigger with 'html deck', 'slide deck', 'presentation pdf', 'domo deck', 'html to pdf slides'."
maturity: alpha
audience: [code]
---
