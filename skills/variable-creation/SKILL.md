...
tier: 0
description: "Create and manage Domo card variables (dropdowns, sliders, pills, date pickers) via 3-step API flow: function templates, control registration, and card save. Covers CLI automation, variable types, control hierarchy, and beast mode integration. Trigger with 'variable', 'card variable', 'dropdown control', 'slider control', 'interactive control', 'what-if analysis'."
maturity: alpha
audience: [code]
---
