...
tier: 0
description: "Vertical App Studio micro-demo with optional dataset creation, ETL pipeline, and multi-page themed layout for industry verticals (manufacturing, healthcare, retail, logistics, financial). Trigger with 'app studio demo', 'vertical demo', 'micro demo domo', 'industry app studio'."
maturity: alpha
audience: [code]
---
