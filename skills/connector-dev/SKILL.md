...
name: connector-dev
tier: 0
description: "Custom Domo connector authorship — writing JavaScript code for authentication.js, dataProcessing.js, and Domo connector APIs (datagrid, httprequest, auth, metadata). Trigger with 'custom connector', 'connector dev studio', 'write a domo connector', 'authentication.js', 'dataProcessing.js'."
maturity: alpha
audience: [code]
---
