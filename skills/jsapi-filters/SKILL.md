...
name: jsapi-filters
tier: 0
description: "Apply runtime filters to embedded Domo dashboards/cards from the host page via JS API MessagePort — dynamic filtering, drill events, iframe resize. Trigger with 'jsapi filter', 'client side filter domo', 'domo embed filter', 'messageport domo', 'pfilter'."
maturity: alpha
audience: [code]
---
