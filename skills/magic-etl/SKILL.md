...
name: magic-etl
tier: 0
description: "Create, update, and execute Magic ETL dataflows programmatically via REST API and Java CLI — DAG-based JSON definitions, joins, aggregations, filters, formulas, window functions. Trigger with 'magic etl', 'create dataflow', 'etl api domo', 'dataflow programmatic', 'magic etl json'."
maturity: alpha
deprecated: true
deprecation_note: "Superseded by upstream dataflow-* chain (v2 product-team): dataflow-spec-design → dataflow-build-and-edit → dataflow-debug."
