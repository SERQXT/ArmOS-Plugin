...
tier: 0
description: "Toolkit-first AIClient patterns for text generation, text-to-sql, beast mode, and response parsing in Domo custom apps. Trigger with 'ai client', 'generate text', 'text to sql', 'domo ai', 'AIClient'."
maturity: alpha
audience: [code]
---
