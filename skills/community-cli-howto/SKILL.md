...
tier: 0
description: "General instructions for the community-domo-cli — install, auth setup (ryuu session), endpoint testing, supported commands, and troubleshooting. Trigger with 'community domo cli', 'domo cli setup', 'community-domo-cli help', 'ryuu session auth'."
maturity: alpha
audience: [code]
---
# Community Domo CLI
