...
name: edit-embed
tier: 0
description: "Set up Domo embedded edit experience — external users create, edit, save Domo content via iframe using Identity Broker JWT auth with role-based access. Trigger with 'edit embed', 'embedded edit', 'identity broker', 'domo edit mode', 'jwt embed domo'."
maturity: alpha
audience: [code]
---
