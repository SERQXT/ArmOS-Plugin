...
tier: 0
description: "Capture animated demo videos and screenshots of deployed Domo App Studio apps using Playwright browser automation. Records smooth walkthroughs of production UI including left-nav, native cards, pro-code cards, themes, and live data. Trigger with 'demo capture', 'record app', 'walkthrough video', 'app screenshots', 'animated preview'."
maturity: alpha
audience: [code]
---
