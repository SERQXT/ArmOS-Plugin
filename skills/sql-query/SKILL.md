...
name: sql-query
tier: 0
description: "Use SqlClient from @domoinc/toolkit for raw SQL queries against Domo dataset aliases, columnar response parsing, page filter injection, and AI text-to-SQL execution patterns. Trigger with 'sql query', 'SqlClient', 'raw sql', 'text to sql execute', 'sql api', 'columnar response'."
maturity: alpha
audience: [code]
---
