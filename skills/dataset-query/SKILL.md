...
name: dataset-query
tier: 0
description: "Query-first dataset access with @domoinc/query including filters, groupBy, dateGrain, periodToDate, rollingPeriod, ordering, pagination, and performance constraints for Domo custom apps. Trigger with 'query api', 'dataset query', '@domoinc/query', 'groupBy', 'dateGrain', 'Query builder'."
maturity: alpha
audience: [code]
---
...
// WARNING: .aggregate() does NOT work in practice
