...
tier: 0
description: "Domo JSON no-code connector via Product API — accounts, streams, executions for REST/JSON API ingestion into Domo datasets. Trigger with 'json connector', 'no code connector', 'json5 connector', 'domo json ingestion', 'api to domo dataset'."
maturity: alpha
audience: [code]
---
