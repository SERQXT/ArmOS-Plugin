...
name: da-cli
tier: 0
description: "Use the @domoinc/da CLI for scaffolding Domo custom apps, generating components and reducers, managing manifest instances, and converting Lovable/v0 apps to Domo. Trigger with 'da cli', 'da new', 'scaffold app', 'generate component', 'convert lovable', 'domo cli scaffold'."
maturity: alpha
audience: [code]
---
