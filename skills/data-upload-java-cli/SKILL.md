...
tier: 0
description: "Java CLI (domoutil.jar) fallback for CSV upload to Domo — schema derivation, chunked uploads, batch upload patterns. Use when JSON connector is not suitable. Trigger with 'upload csv to domo', 'domoutil', 'java cli upload', 'data upload cli', 'csv to domo'."
maturity: alpha
audience: [code]
---
